...
**Related skills:** [senior-leadership-advisor](../senior-leadership-advisor/SKILL.md) supplies the role catalog and the general team protocol this workflow specializes. Reach for it when the request is a *decision or a critique*; reach for this skill when there is something to construct across sessions. [agentic-engineering](../agentic-engineering/SKILL.md) produces the brief this workflow's Stage 1 consumes. This skill is the Structure pillar of [promethean-parthenon](../promethean-parthenon/SKILL.md), which routes between all four.
