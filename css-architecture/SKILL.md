...
**When migrating:** Do not suggest rewriting everything at once. Follow the 3-phase migration plan in [migration-guide](references/migration-guide.md).
...
> For project-size variants (small / medium / large), see [folder-templates](references/folder-templates.md)
...
> For `@layer` deep dive, common mistakes, and v3/v4 specificity charts, see [layer-system](references/layer-system.md)
...
> For detailed before/after examples of all 10 patterns, see [anti-patterns](references/anti-patterns.md)
...
> For Stylelint setup and `.stylelintrc` config, see [linting-setup](references/linting-setup.md)
...
| File | Read When |
|---|---|
| [folder-templates](references/folder-templates.md) | Scaffolding a new project or choosing structure size |
| [layer-system](references/layer-system.md) | Debugging specificity conflicts or learning `@layer` |
