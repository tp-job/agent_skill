...
**Related skill:** this is the Judgment pillar of [promethean-parthenon](../promethean-parthenon/SKILL.md), which routes between briefing, building, deciding, and recording.
