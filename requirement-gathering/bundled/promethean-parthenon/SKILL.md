...
| --- | --- | --- | --- |
| **Role** | Who is answering, and to what standard? | [senior-leadership-advisor](../senior-leadership-advisor/SKILL.md) | competent execution of a bad decision |
| **Task** | What is being done, against what target, proven how? | [requirement-gathering](../requirement-gathering/SKILL.md) · [agentic-engineering](../agentic-engineering/SKILL.md) · [long-horizon-engineering-workflow](../long-horizon-engineering-workflow/SKILL.md) | invented rules, then silent drift |
| **Format** | What shape does the output take, and what survives? | [github-report](../github-report/SKILL.md) | invisible work, re-argued decisions |
