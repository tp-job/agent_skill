...
**Related skill:** this is the **Role** pillar of [promethean-parthenon](../promethean-parthenon/SKILL.md), which organises agent work as Role · Task · Format. Role is stepped into, not passed through — it carries load at the design gates, on anything that has failed twice, when the target and reality disagree, and before anything irreversible. The **Task** pillar does the constructing ([requirement-gathering](../requirement-gathering/SKILL.md), [agentic-engineering](../agentic-engineering/SKILL.md), [long-horizon-engineering-workflow](../long-horizon-engineering-workflow/SKILL.md)); [github-report](../github-report/SKILL.md) is **Format**.
