...
**Related skill:** this is the Record pillar of [promethean-parthenon](../promethean-parthenon/SKILL.md), which routes between briefing, building, deciding, and recording.
