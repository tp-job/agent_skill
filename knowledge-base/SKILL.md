...
|--------|------|---------------|
| Architecture | [architecture](references/architecture.md) | System architecture patterns, trade-offs, scalability |
| Component-Based Architecture | [component-based-architecture](references/component-based-architecture.md) | Component design, composition, atomic design |
| Security | [security](references/security.md) | Security fundamentals, threat modeling, secure defaults |
| Software Design 2024 | [software-design-2024](references/software-design-2024.md) | Modern design principles, Clean Architecture, DDD |
| Use Cases + Microservices + 3-Tier | [usecase-microservices-3tier](references/usecase-microservices-3tier.md) | Use case modeling, Microservices patterns, 3-tier design |
...
| File | Read When |
|------|-----------|
| [architecture](references/architecture.md) | System design, architectural decisions |
| [component-based-architecture](references/component-based-architecture.md) | Component design, atomic design, composition |
| [security](references/security.md) | Security review, threat modeling |
| [software-design-2024](references/software-design-2024.md) | Design principles, Clean Architecture, DDD |
| [usecase-microservices-3tier](references/usecase-microservices-3tier.md) | Use case modeling, Microservices, 3-tier |
